...
download_xui(){
    ...
    wget -N --no-check-certificate -O /usr/local/x-ui-linux-$(archAffix).tar.gz https://raw.githubusercontent.com/reno1314/x-ui-1/master/x-ui-linux-$(archAffix).tar.gz
    if [[ $? -ne 0 ]]; then
    ...
    wget -N --no-check-certificate https://raw.githubusercontent.com/reno1314/x-ui-1/master/x-ui.sh -O /usr/bin/x-ui
