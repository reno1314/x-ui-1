...
download_xui(){
    ...
    wget -N --no-check-certificate -O /usr/local/x-ui-linux-$(archAffix).tar.gz https://gitlab.com/reno/x-ui-1/-/raw/main/x-ui-linux-$(archAffix).tar.gz
    if [[ $? -ne 0 ]]; then
    ...
    wget -N --no-check-certificate https://gitlab.com/reno/x-ui-1/-/raw/main/x-ui.sh -O /usr/bin/x-ui
